...
const Card = ({ loding, colors, fetchColors, Color }) => {
  ...
  return (
    // Card container
    <div className="w-[33vw] h-screen card_con_left grid place-content-center max-md:hidden themeLgbg smoot_transition  fixed left-0 top-0 bottom-0 right-[60vw] overflow-hidden">
      {/* card */}
